...
A simple and fast restricted rich-text editor using [Electron](https://www.electronjs.org/) and [TinyMCE 5](https://github.com/tinymce/tinymce). Also supports markdown via [Showdown](https://github.com/showdownjs/showdown) integrated into TinyMCE ([modified plugin](https://www.tiny.cloud/labs/markdown/)). Runs on Windows, macOS, Linux, and Chrome OS (via Crostini).
